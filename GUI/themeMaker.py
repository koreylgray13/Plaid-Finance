...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.widget_type = customtkinter.CTkLabel(master=self.frame_info, text=self.current, corner_radius=10,
                                                  width=200, height=20,
                                                  fg_color=("white", "gray38"))
        self.widget_type.grid(row=0, column=0, sticky="nswe", padx=80, pady=20)

        self.left_button = customtkinter.CTkButton(master=self.frame_info, text="<", width=20, height=20,
                                                   corner_radius=10,
                                                   fg_color=("white", "gray38"), command=self.change_mode_left)
        self.left_button.grid(row=0, column=0, sticky="nsw", padx=20, pady=20)

        self.right_button = customtkinter.CTkButton(master=self.frame_info, text=">", width=20, height=20,
                                                    corner_radius=10,
                                                    fg_color=("white", "gray38"), command=self.change_mode_right)
        self.right_button.grid(row=0, column=0, sticky="nse", padx=20, pady=20)

        self.menu = customtkinter.CTkOptionMenu(master=self.main, fg_color=("white", "gray38"),
                                                button_color=("white", "gray38"),
                                                button_hover_color=None, height=30,
                                                values=list(self.widgets.items())[0][1], command=self.update)
        self.menu.grid(row=1, column=0, columnspan=6, sticky="nswe", padx=20)

        self.button_light = customtkinter.CTkButton(master=self.main, height=100, width=200, corner_radius=10,
                                                    border_color="white",
                                                    fg_color=None, border_width=2, text="Light", hover_color=None,
                                                    command=self.change_color_light)
        self.button_light.grid(row=2, column=0, sticky="nswe", columnspan=3, padx=(20, 5), pady=20)

        self.button_dark = customtkinter.CTkButton(master=self.main, height=100, width=200, corner_radius=10,
                                                   border_color="white",
                                                   fg_color=None, border_width=2, text="Dark", hover_color=None,
                                                   command=self.change_color_dark)
        self.button_dark.grid(row=2, column=3, sticky="nswe", columnspan=3, padx=(5, 20), pady=20)

        self.button_load = customtkinter.CTkButton(master=self.main, height=40, width=110, text="Load Theme",
                                                   command=self.load)
        self.button_load.grid(row=3, column=0, columnspan=2, sticky="nswe", padx=(20, 5), pady=(0, 20))

        self.button_export = customtkinter.CTkButton(master=self.main, height=40, width=110, text="Save Theme",
                                                     command=self.save)
        self.button_export.grid(row=3, column=2, columnspan=2, sticky="nswe", padx=(5, 5), pady=(0, 20))

        self.button_reset = customtkinter.CTkButton(master=self.main, height=40, width=110, text="Reset",
                                                    command=self.reset)
    ...
    def change_color_light(self):
        color1 = \
        askcolor(title="Choose color for " + self.menu.get() + " (Light)", initialcolor=self.button_light.fg_color)[1]
    ...
    def change_color_dark(self):
        color2 = \
        askcolor(title="Choose color for " + self.menu.get() + " (Dark)", initialcolor=self.button_dark.fg_color)[1]
    ...
    def save(self):
        save_file = tkinter.filedialog.asksaveasfilename(initialfile="Untitled.json",
